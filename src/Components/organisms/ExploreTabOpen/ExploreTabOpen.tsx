    ...
    >
      <Box display={"flex"}>
        <Box sx={{ marginLeft: "250px", marginTop: "30px" }}>
          <Typography className={styles.exploreByOptionTypography}>
            Explore By Category
          </Typography>
        </Box>
        <Box sx={{ marginLeft: "130px", marginTop: "30px" }}>
          <Typography className={styles.otherOptionTypography}>
      ...
      <Grid
        container
        rowSpacing={"20px"}
        sx={{ width: "940px", marginTop: "4px", marginLeft: "250px" }}
      >
          ...
          return (
            <Grid item md={4}>
              <IconText
                imgSrc={data.imgSrc}
                title={data.title}
                onClick={() => openEntrepreneurshipPage(data.title)}
                variant="body2"
              />
            </Grid>
          );
